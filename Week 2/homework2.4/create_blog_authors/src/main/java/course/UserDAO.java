...
public class UserDAO {
    ...
    public boolean addUser(String username, String password, String email) {
        ...
        try {
            ...
            System.out.println("***********Inserting Document :" + username );
    ...
    public Document validateLogin(String username, String password) {
        ...
        FindIterable<Document> userDocs = usersCollection.find(filter);

        if(userDocs != null && userDocs.iterator().hasNext()){
            user = userDocs.iterator().next();
        }
